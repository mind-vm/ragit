...
- Whether the nested-scope cascade (§8) is needed at launch for the first `ragit`-using project, or whether flat `tenant_id` is enough and the extra columns just sit reserved.
